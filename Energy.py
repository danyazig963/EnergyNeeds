...
st.write('The average wind speed data presented in the map above was obtained from the NASA website. You can easily access the data from the following link: https://disc.gsfc.nasa.gov/datasets/FLDAS_NOAH01_C_GL_M_001/summary')
...
st.markdown("I am currently working on expanding this program to include other forms of clean energy so that users can have a wider range of options to choose from. This will allow them to select the most suitable system for their energy needs based on their current circumstances. In addition, the article I wrote explaining this algorithm is under review by the reviewers of a journal, which I plan to publish after the editor's final approval to provide more information to experts and the public. I hope that my efforts can make a small contribution toward improving both society and the environment.")